...
if ( ! function_exists( 'hazo_setup' ) ) :
	...
	function hazo_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'hazo' ),
		) );
...
function hazo_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Trang chủ', 'hazo' ),
		'id'            => 'sidebar-2',
...
function hazo_scripts() {
	wp_enqueue_style( 'hazo-style', get_stylesheet_uri() );
	...
	wp_enqueue_script( 'hazo-jquery', get_template_directory_uri() . '/assets/js/jquery.min.js', array(), '20151215', true );
	
	wp_enqueue_script( 'hazo-index', get_template_directory_uri() . '/assets/js/style.js', array(), '20151215', true );

	wp_enqueue_script( 'hazo-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'hazo-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
